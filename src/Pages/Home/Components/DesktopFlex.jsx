...
function DesktopFlex() {
  ...
  return (
    <>
      <div className="w-full min-h-[20vh] min-w-[430px] sm:min-w-[640px] md:min-w-[768px] lg:min-w-[1024px] xl:min-w-[1280px] flex flex-col sm:flex-row gap-2 justify-center my-2 px-2 sm:px-7">
