...
function MobileCards() {
  return (
    <div className="px-[2%] py-[3%] flex gap-2 overflow-x-auto no-scrollbar overflow-y-hidden sm:hidden min-w-[430px] sm:min-w-[640px] md:min-w-[768px] lg:min-w-[1024px] xl:min-w-[1280px] bg-orange-100">
