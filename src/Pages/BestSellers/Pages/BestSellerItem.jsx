...
function BestSellerItem() {
  ...
  return (
    <>
      {book.length > 0 && (
        <div className="bg-gray-100 min-w-[576px] sm:min-w-[1100px] min-h-[85vh] px-[2%] sm:px-[3%] pt-[4%] flex gap-2 flex-col sm:flex-row justify-center overflow-scroll lg:overflow-hidden ">
          <img
