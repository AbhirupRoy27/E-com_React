...
function GiftCards() {
  return (
    <div className="min-w-[344px]">
      <div className="flex justify-center items-center min-w-[100vw] sm:min-w-[640px] md:min-w-[768px] lg:min-w-[1024px] xl:min-w-[1280px] max-h-[15vh] md:max-h-[20vh] overflow-hidden">
        <img
