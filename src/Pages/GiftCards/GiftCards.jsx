...
function GiftCards() {
  return (
    <div className="min-w-[354px] min-h-screen">
      <div className="flex justify-center items-center min-w-[354px] max-h-[15vh] md:max-h-[20vh] overflow-hidden">
        <img
      ...
      <div className="flex min-w-[350px] overflow-hidden">
        <div className="hidden min-w-[15%] lg:flex flex-col px-2 py-3 items-center border-r-2 border-gray-300 mr-3">
