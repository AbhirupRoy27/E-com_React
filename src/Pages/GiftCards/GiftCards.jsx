...
function GiftCards() {
  return (
    <div className="min-w-[344px]">
      <div className="flex justify-center items-center min-w-[430px] sm:min-w-[640px] md:min-w-[768px] lg:min-w-[1024px] xl:min-w-[1280px] max-h-[15vh] md:max-h-[20vh] overflow-hidden">
        <img
      ...
      <div className="flex max-w-[100vw] min-w-[344px]">
        ...
        <div className="flex flex-col overflow-hidden min-w-[576px] sm:min-w-[1100px] sm:w-full">
          <Logo />
          <BigCard />
        </div>
      </div>
